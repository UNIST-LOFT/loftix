...
Reproducing commands can be generated by the `expose` Guix extension
e.g. `guix expose CVE-2017-15025`.  Following are the origins
of the proof-of-concept input files.

## Audio File

- [CVE-2017-6827](https://blogs.gentoo.org/ago/2017/02/20/audiofile-heap-based-buffer-overflow-in-msadpcminitializecoefficients-msadpcm-cpp/)
- [CVE-2017-6828](https://blogs.gentoo.org/ago/2017/02/20/audiofile-heap-based-buffer-overflow-in-readvalue-filehandle-cpp/)
- [CVE-2017-6830](https://blogs.gentoo.org/ago/2017/02/20/audiofile-heap-based-buffer-overflow-in-alaw2linear_buf-g711-cpp/)
- [CVE-2017-6831](https://blogs.gentoo.org/ago/2017/02/20/audiofile-heap-based-buffer-overflow-in-imadecodeblockwave-ima-cpp/)
- [CVE-2017-6833](https://blogs.gentoo.org/ago/2017/02/20/audiofile-divide-by-zero-in-blockcodecrunpull-blockcodec-cpp/)
- [CVE-2017-6834](https://blogs.gentoo.org/ago/2017/02/20/audiofile-heap-based-buffer-overflow-in-ulaw2linear_buf-g711-cpp/)
- [CVE-2017-6835](https://blogs.gentoo.org/ago/2017/02/20/audiofile-divide-by-zero-in-blockcodecreset1-blockcodec-cpp/)
- [CVE-2017-6836](https://blogs.gentoo.org/ago/2017/02/20/audiofile-heap-based-buffer-overflow-in-expand3to4modulerun-simplemodule-h/)
- [CVE-2017-6837](https://blogs.gentoo.org/ago/2017/02/20/audiofile-multiple-ubsan-crashes/)
- [CVE-2017-6838](https://blogs.gentoo.org/ago/2017/02/20/audiofile-multiple-ubsan-crashes/)
