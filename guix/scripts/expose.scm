  ...
  `(("audiofile-unpatched"
    ...
    ("jq"
     ...
     (("CVE-2025-48060" "1.7.1" "asan")
      ("jq" "-nf ~a" "cve/2025/48060/3272.jq" "cve/2025/48060/3373.jq")))
    ("lame"
    ...
    ("libmobi"
     (("CVE-2021-3751" "0.6" "asan")
      ("mobitool" "-do /tmp ~a" "cve/2021/3751/ncx.mobi"))
     (("CVE-2021-3881" "0.6" "asan")
      ("mobitool" "-do /tmp ~a" "cve/2021/3881/ncx.mobi"))
     (("CVE-2021-3888" "0.7" "asan")
      ("mobitool" "-do /tmp ~a" "cve/2021/3888/vishnu.mobi"))
     (("CVE-2022-1533" "0.10" "asan")
      ("mobitool" "-eo /tmp ~a" "cve/2022/1533/poc_s.mobi"))
     (("CVE-2022-1534" "0.10" "asan")
      ("mobitool" "-eo /tmp ~a" "cve/2022/1534/poc.mobi"))
     (("CVE-2022-1907" "0.10" "asan")
      ("mobitool" "-eo /tmp ~a" "cve/2022/1907/poc4.mobi"))
     (("CVE-2022-1908" "0.10" "asan")
      ("mobitool" "-eo /tmp ~a" "cve/2022/1908/poc5.mobi"))
     (("CVE-2022-1987" "0.10" "asan")
      ("mobitool" "-eo /tmp ~a" "cve/2022/1987/poc.mobi"))
     (("CVE-2022-2279" "0.10" "asan")
      ("mobitool" "-eo /tmp ~a" "cve/2022/2279/poc_n.mobi")))
    ("libtiff"
     (("CVE-2014-8128" "4.0.3")
